...
$database = mysqli_connect("localhost", "root", "", "job-board");
                    ...
                    <header>
                        <div id="nav-bar">
                            <nav class="navbar navbar-expand-lg pl-0">
                                <a class="navbar-brand text-decoration-none" href="index.php">Lopper</a>
                ...
                <div class="job-posts">
                    <div class="col-sm-4">
                        <div class="job">
                            ...
                            <p class="pt-3">Eget nulla facilisietiam dignissim diam quis enim lobortis scelerisque. Eu
                                feugiat pretium
                                nibh
                                ipsum consequat nisl vel pretium. </p>
                            <a href="#">
                                <button type="button" class="btn btn button-lookmore">Look More</button>
                            </a>
